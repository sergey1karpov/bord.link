    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h5 style="font-size:1.1em" class="text-muted">{{route('profile', ['id' => $user->nickname])}}</h5>
                <br>
        ...
        <div class="row" >
            ...
            <div class="col-12 menu left-column fixed-top sticky-top" id="menu">
                <div class="navbar navbar-dark " style="padding-left:8px; padding-right: 8px; background-color: #040404">
                    <a style="text-decoration: none" href="{{route('profile', ['id' => $user->nickname])}}"><h1 class="display-4" style="font-family: 'Jost', sans-serif; font-size: 1.2em; margin-bottom: 0; color: #f4f4f2; text-transform: uppercase; "><b>{{$user->name}}</b>
                    @if($user->verify)
                                    ...
                                    @if(Auth::check())
                                        @if(Auth::user()->id != $user->id)
                                            <div class="col-2 text-right" style="padding:0">
                                                <form action="{{route('followUser', ['id' => Auth::user()->id, 'userId' => $user->id])}}" method="POST">
                                                    @csrf @method('PATCH')
